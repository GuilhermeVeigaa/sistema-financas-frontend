    ...
    <table className="w-full bg-zinc-100 p-5 shadow-md rounded-md max-w-4xl my-5 mx-auto break-all">
      <thead>
        <tr>
          ...
          <th className="text-start pb-1 border-b-2 border-zinc-500 text-zinc-800">Valor</th>
      ...
      <tbody>
        {expenses.map((item: any, i: any) => (
          <tr key={i}>
            ...
            <td className="pt-4 me-3 text-start text-wrap text-zinc-600" width="30%">{item.value}</td>
